...
# generated models in terminal - Studio, Movie, Actor, Role
# created table fields in the db/migrate directory
...
knightrises = Movie.find_by({"title" => "The Dark Knight Rises"})
...
new_role = Role.new
new_role["movie_id"] = knightrises["id"]
new_role["actor_id"] = bale["id"]
new_role["character_name"] = "Bruce Wayne"
new_role.save
